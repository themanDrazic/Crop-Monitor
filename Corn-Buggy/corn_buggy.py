...
def Threshold(calibration,channel,window_name,points_dict,thre_type,thre_value):
	# 0: Binary
	# 1: Binary Inverted
...
def cvAlgorithm(calibration=False,points_dict=dict(),thre_type=3,thre_value=175):
	if calibration:
